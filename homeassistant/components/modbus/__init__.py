...
SWITCH_REGISTERS_SCHEMA = vol.Schema(
    {
...
SWITCH_COILS_SCHEMA = vol.Schema(
    {
...
SWITCH_SCHEMA = vol.All(
    ...
    BASE_COMPONENT_SCHEMA.extend(
        {
            vol.Optional(CALL_TYPE_COIL): [SWITCH_COILS_SCHEMA],
            vol.Optional(CONF_REGISTER): [SWITCH_REGISTERS_SCHEMA],
        },
    ),
)
